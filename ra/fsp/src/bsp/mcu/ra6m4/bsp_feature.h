...
#define BSP_FEATURE_ADC_UNIT_0_CHANNELS_MASK                            (0x33FFUL)      // Mask of available channels in ADC unit 0.
#define BSP_FEATURE_ADC_UNIT_1_CHANNELS_MASK                            (0x007F0007UL)  // Mask of available channels in ADC unit 1.
